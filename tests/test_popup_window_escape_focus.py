...
def test_escape_always_closes_regardless_of_focus():
    """Kursplaners eigene ScrollablePopupWindow-Subklasse hat keine eigene
    _handle_escape_request-Ueberschreibung mehr und erbt daher direkt das
    unbedingt schliessende Verhalten der bw-gui-Basisklasse (siehe
    bw-gui/tests/test_scrollable_popup.py fuer den analogen Basisklassen-Test)."""
    popup = _FakePopup()
