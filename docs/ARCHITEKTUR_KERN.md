...
| `kursplaner/adapters/gui/overview_controller.py` | ~426 (2026-08-09 nachgetragen; vorher ~417) | Verwaltet Kursübersicht, Detailview-Wechsel, Tageslog und Reload-Flows. Zusammenhängende Zustandsmaschine; Aufspaltung würde zyklische Abhängigkeiten erzeugen. Wuchs 2026-08-09 um den Archivierungs-Trigger in `refresh_overview()` (`ArchiveFormerCoursesUseCase`-Aufruf inkl. `skip_paths`-Ableitung). |
